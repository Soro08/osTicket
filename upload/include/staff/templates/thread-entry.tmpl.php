...
<?php } ?>
    <div class="header sorocollapsible" style="cursor: pointer;">
        <div class="pull-right">
            ...
            <?php
                    ...
                    <!-- Classe a mettre à jour en cas de visibilité -->
    <div class="thread-body no-pjax usermessage" style="display:none">
